...
public class TestActivityPhy extends AppCompatActivity {
    Button bt_next,bt_close;
    TextView tv_question;
    RadioGroup radioGroup;
    String result_test;

    SharedPreferences save_phy;

    public static final String SVRSGL_RSP = "SVRSGL_RSP";
    int result = 0;
    int question = 0;
    TestPhy test;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save_phy = getSharedPreferences(SAVE_DATA,MODE_PRIVATE);
        ...
        bt_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences.Editor editor = save_phy.edit();
                editor.putString(SVRSGL_RSP,result_test);
                editor.apply();
                finish();
            }
        });
