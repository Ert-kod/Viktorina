...
public class TestActivityHistory_game extends AppCompatActivity {
    ...
    public static final String SVRSGL_RSH = "SVRSGL_RSH";
    int result = 0;
    int question = 0;
    TestHis test;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString(SVRSGL_RSH,result_test);
                editor.apply();
                finish();
            }
        });
