...
public class TestActivityDoom extends AppCompatActivity {
    Button bt_next,bt_close;
    TextView tv_question;
    RadioGroup radioGroup;
    String result_test;

    SharedPreferences save_doom;

    public static final String SVRSGL_RSD = "SVRSGL_RSD";
    int result = 0;
    int question = 0;
    TestDoom test;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save_doom = getSharedPreferences(SAVE_DATA,MODE_PRIVATE);
        ...
        bt_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences.Editor editor = save_doom.edit();
                editor.putString(SVRSGL_RSD,result_test);
                editor.apply();
                finish();
            }
        });
